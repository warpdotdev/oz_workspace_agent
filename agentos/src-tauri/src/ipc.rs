...
pub async fn create_agent(
    ...
    println!("[IPC] Creating agent: {}", request.name);
    ...
    println!("[IPC] Agent created: {} ({})", agent.name, agent.id);
...
pub async fn update_agent(
    ...
    println!("[IPC] Agent updated: {} ({})", agent.name, agent.id);
...
pub async fn set_agent_status(
    ...
    let agent = state.storage.update_agent(agent).await?;
    println!("[IPC] Agent {} status set to {:?}", id, status);
    Ok(agent)
}
...
pub async fn dispatch_task(
    ...
    println!("[IPC] Dispatching task: {}", request.title);
